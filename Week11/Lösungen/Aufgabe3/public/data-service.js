...
async function submitComment(comment) {
  return postJson(postsRESTServerURL + commentsRoute, comment);
}

async function deleteComment(commentId) {
  return deleteResource(`${postsRESTServerURL + commentsRoute}/${commentId}`);
}

export default {getPosts, submitPost, getComments, submitComment, deleteComment};
